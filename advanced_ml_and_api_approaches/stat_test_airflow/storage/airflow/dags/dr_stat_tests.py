...
from nodes import test_arch, test_normality, test_stationarity, test_cooks_distance, test_autocorrelation

SLACK_WEBHOOK = 'https://hooks.slack.com/services/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'
...
def compose_blueprint(project_id:str, model_id:str=''):
    ...
    kerasc_blueprint = w.BlueprintGraph(
        kerasc,
        name='Custom Keras BP (1 layer: 64 units) with T-test'
    )
...
with DAG(
    ...
    score_predictions_op >> scoring_complete_sensor >> [t3, t4, t5, t6, t7] >> register_results >> render_docs
